...
import 'package:masterstudy_app/ui/screen/home/items/paid_items.dart';
      ...
      return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            switch (item.id) {
              ...
              case 5:
                return PaidWidget(false, "All Paid Courses", state.coursesFree);
              // case 6:
              //   return PaidWidget(false, "Paid Items", state.coursesFree);
              default:
                return NewCoursesWidget(item.name, state.coursesNew);
            }
          });
